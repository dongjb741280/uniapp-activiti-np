				...
				<view class="u-calendar__content__item" :class="{
				 ...
				 @tap="dateClick(index)">
					<view class="u-calendar__content__item__inner" :style="{color: getColor(index,2)}">
						<view class="inner-item u-m-b-20"  style="font-size:22px">{{ index + 1 }}</view>
						<view class="inner-item signin">
                            <view class="u-flex u-row-center" style="width:16px;height:16px;"><view class="iconfont">&#xe631;</view></view>
                            <view class="time">08:58</view>
                        </view>
                        <view class="inner-item signin">
                            <view class="u-flex u-row-center" style="width:16px;height:16px;"><view class="iconfont">&#xe653;</view></view>
                            <view class="time">18:02</view>
                        </view>
					</view>
