...
export const STYLE_NORMAL = Pinyin.STYLE_NORMAL;
export const STYLE_TONE = Pinyin.STYLE_TONE;
export const STYLE_TONE2 = Pinyin.STYLE_TONE2;
export const STYLE_TO3NE = Pinyin.STYLE_TO3NE;
export const STYLE_INITIALS = Pinyin.STYLE_INITIALS;
export const STYLE_FIRST_LETTER = Pinyin.STYLE_FIRST_LETTER;


export const compare = pinyin.compare.bind(pinyin);
const py = pinyin.convert.bind(pinyin);
export default py;