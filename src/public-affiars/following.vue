<template>
	<view class="gray-bg">
		<u-navbar title="跟踪" :background="$store.state.backgroundTempalte.common"></u-navbar>
...
export default {
	...
	methods: {
        getParams() {
            ...
            params.url = this.current == 0 ? '/oa-server/a/oa/acrossServices/qryApplyInProgressListByCon' : '/oa-server/a/oa/acrossServices/qryApplyFinishedListByCon';
            return params
        },
        qryListData() {
